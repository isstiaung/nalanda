...
> **Status: revised proposal (2026-07-03) — incorporates review decisions (§16). No code yet.**
> This doc is the source of truth for architecture decisions; CLAUDE.md holds day-to-day
> working conventions.

A self-hosted, libib-style library manager for the household: catalog **books, board games,
...
5. Name: TBD — worker + D1 named `personal-library` until chosen.
